...
export const mockPlaces: Place[] = [
  ...
  },
  {
    ...
    rating: 4.6,
    studentDiscount: "10% off with student ID",
    address: "10171 Estero Town Commons Pl, Ste 306, Estero, FL",
    hours: "10:30am - 9pm",
    description: "Healthy salads, grain bowls, wraps, and smoothies. Fresh, nutritious meals made with clean ingredients.",
    priceLevel: 2,
  },
  {
    id: "5",
    ...
    distance: "5.8 mi",
    rating: 4.7,
    studentDiscount: "Free edamame with bowl",
    address: "13499 S Cleveland Ave, Fort Myers, FL",
    hours: "11am - 9pm",
    description: "Fresh poke bowls with premium fish, customizable toppings, and signature sauces. Build your perfect bowl.",
    priceLevel: 2,
  },
  {
    id: "6",
...
export const mockScannedFoods: ScannedFood[] = [
  ...
  },
  {
    ...
    sodium: 59,
    prices: [
      { store: "Publix", price: 12.99 },
      { store: "Trader Joe's", price: 10.99 },
